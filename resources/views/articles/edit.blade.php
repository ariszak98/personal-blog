                ...
                <div style="max-width: 85%; margin: 50px auto; background-color: #fff; padding: 20px;">
                    ...
                    <form action="/article/update/{{ $article->id }}" method="post">
                      ...
                      <div style="margin-bottom: 20px;">
                        ...
                        <input value="{{ $article->title }}" type="text" id="title" name="title"  style="width: 100%; padding: 10px; font-size: 16px; border: none; border-radius: 5px;">
                        @error('title')
                      ...
                      <div style="margin-bottom: 20px;">
                        ...
                        <textarea required cols="50" id="body" name="body" rows="5"  style="width: 100%; padding: 10px; font-size: 16px; border: none; border-radius: 5px; resize: vertical;">{{ $article->body }}</textarea>
                        @error('body')
                            <p class="text text-red-500 mt-1">{{ $message }}</p>
                        @enderror
                      </div>

                      <button type="submit" style="background-color: #e6e6e6; color: rgb(0, 0, 0); padding: 12px 20px; border: none; border-radius: 4px; cursor: pointer; font-size: 16px;">Update</button>
                    </form>
