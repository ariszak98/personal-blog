                             ...
                             <div class="grid-full grid-list-items">
                                 ...
                                 <div class="grid-list-items__item blog-card">
                                     <div class="blog-card__header">
                                         ...
                                         <h3 style="font-weight: semibold; font-size: 1.7em;" class="blog-card__title"><a class="hover:text-blue-500" href="https://www.dreamhost.com/r.cgi?287326">Need Web Hosting for Your Websites?</a></h3>
                                     </div>
                                 ...
                                 <div class="grid-list-items__item blog-card">
                                     <div class="blog-card__header">
                                         ...
                                         <h3 style="font-weight: semibold; font-size: 1.7em;" class="blog-card__title"><a class="hover:text-blue-500"  href="single.html">7 SEO Factors to Consider for Better Website Ranking</a></h3>
                                     </div>
                                     <div class="blog-card__text">
                                         <p>
                                 ...
                                 <div class="grid-list-items__item blog-card">
                                     <div class="blog-card__header">
                                         ...
                                         <h3 style="font-weight: semibold; font-size: 1.7em;" class="blog-card__title"><a class="hover:text-blue-500"  href="single.html">5 Effective Web Design Principles</a></h3>
                                     </div>
                                     <div class="blog-card__text">
                                         <p>
