@section('title', 'About Me | Zakynthinos A.')
                    ...
                    <figure class="page-media">                                
                        <img src="{{ asset('images/thumbs/about/about-1200.jpg') }}" 
                            srcset="{{ asset('images/thumbs/about/about-2400.jpg') }} 2400w, 
                                    {{ asset('images/thumbs/about/about-1200.jpg') }} 1200w, 
                                    {{ asset('images/thumbs/about/about-600.jpg') }} 600w" sizes="(max-width: 2400px) 100vw, 2400px" alt="">
                    </figure>
                </d>
            </div> <!-- end pagemedia -->
