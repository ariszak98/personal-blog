@section('title', 'Contact Me | Zakynthinos A.')
                         ...
                         <figure class="page-media">                                
                             <img src="{{ asset('images/thumbs/contact/contact-1200.jpg') }}" 
                                  srcset="{{ asset('images/thumbs/contact/contact-2400.jpg') }} 2400w, 
                                          {{ asset('images/thumbs/contact/contact-1200.jpg') }} 1200w, 
                                          {{ asset('images/thumbs/contact/contact-600.jpg') }} 600w" sizes="(max-width: 2400px) 100vw, 2400px" alt="">
                         </figure>
                     </d>
                 </div> <!-- pagemedia --> 
                     ...
                     <div class="column xl-12">
                         ...
                         <div class="row">
                             <div class="column xl-6 md-12 contact-cta">     
                                 ...
                                 <a href="mailto:#0" class="mt-2 btn btn--primary u-fullwidth contact-btn">
